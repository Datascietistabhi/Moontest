...
// candidates at the last checkpoint that is already hard coded into bronchain
...
// uses the format the bronchain code expects for checkpoints added to the list.
