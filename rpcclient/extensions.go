...
//
// NOTE: This is a bronwallet extension.
...
// managed by bronwallet are only written to disk with encrypted private keys,
...
// used by bronwallet to enable a wallet which does not have the private keys
