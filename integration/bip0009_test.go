// Copyright (c) 2016 The bronsuite developers
...
// TestBIP0009Mining ensures blocks built via brond's CPU miner follow the rules
...
func TestBIP0009Mining(t *testing.T) {
	...
	// version since the brond mining code will have recognized the test
